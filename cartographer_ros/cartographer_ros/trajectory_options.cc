...
TrajectoryOptions CreateTrajectoryOptions(
  ...
  options.publish_transforms = lua_parameter_dictionary->GetBool("publish_transforms");
...
bool FromRosMessage(const cartographer_ros_msgs::TrajectoryOptions& msg,
  ...
  options->publish_transforms = msg.publish_transforms;
...
cartographer_ros_msgs::TrajectoryOptions ToRosMessage(
  ...
  msg.publish_transforms = options.publish_transforms;
